...
function Hero() {
  return (
    <section className="bg-brand-navy relative overflow-hidden min-h-[580px] md:min-h-[640px]">
      {/* 装飾グラデーション */}
      <div
        className="absolute inset-0 opacity-10"
        style={{
          backgroundImage: 'radial-gradient(circle at 25% 60%, #e04102 0%, transparent 55%)',
        }}
      />
      ...
      <div className="hidden md:block absolute inset-y-0 right-0 w-1/2">
        ...
        />
        {/* 左端をnavyにフェード */}
        <div className="absolute inset-y-0 left-0 w-48 bg-gradient-to-r from-brand-navy to-transparent" />
      </div>
